...
export function LoginForm({ initialIdentifier, onSuccessRedirect, redirectTo }: LoginFormProps) {
  ...
  return (
    <section className="island-shell rise-in relative overflow-hidden rounded-[2rem] px-6 py-8 sm:px-8 sm:py-10">
      ...
      {currentUser ? (
        <div className="mb-5 rounded-2xl border border-[rgba(47,106,74,0.18)] bg-[rgba(79,184,178,0.1)] px-4 py-3 text-sm text-[var(--sea-ink)]">
      ...
      <form className="grid gap-4" onSubmit={handleSubmit}>
        ...
        <button
          ...
          className="mt-2 inline-flex h-11 items-center justify-center rounded-full border border-[rgba(50,143,151,0.3)] bg-[rgba(79,184,178,0.18)] px-5 text-sm font-semibold text-[var(--lagoon-deep)] transition hover:-translate-y-0.5 hover:bg-[rgba(79,184,178,0.26)] disabled:cursor-not-allowed disabled:opacity-60"
        >
