...
function DevtoolPanel() {
  ...
  return (
    <div className="grid grid-cols-[1fr_10fr] gap-4 p-4">
      <div className="whitespace-nowrap font-bold text-gray-500 text-sm">First Name</div>
      <div className="text-sm">{state?.firstName}</div>
      <div className="whitespace-nowrap font-bold text-gray-500 text-sm">Last Name</div>
      <div className="text-sm">{state?.lastName}</div>
      <div className="whitespace-nowrap font-bold text-gray-500 text-sm">Full Name</div>
